                ...
                <div class="row">
                    <div class="col">
                     <div class="divider">
                       ...
                       <!-- [] -->
                        <div class="col">
                          <h2 class="header">Uspešno ste ulogovani!</h2>
                          <p>Dobrodošli, <strong><?php echo $_SESSION['korisnicko']; ?></strong></p>
                          
                       </div>
                       <?php
                          header( "refresh:2; url=kalendar.php" );
                        ?>
                     </div>
                    </div>
                    <div class="col">
