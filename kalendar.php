                ...
                <div class="row justify-content-center">
                            <tr class="">
                              <td>
                                <div class="divider"></div>
                                <p class="infoStanje">
                                  Vaš odgovor je: <b> <?php echo "$ponedeljak"; ?> </b> <br><br><br></p>
                              </td>

                              <td>
                                <div class="divider"></div>
                                  <p class="infoStanje">
                                  Vaš odgovor je: <b> <?php echo "$utorak"; ?> </b> <br><br><br></p>
                              ...
                              <td>
                                <div class="divider"></div>
                                  <p class="infoStanje">
                                  Vaš odgovor je: <b> <?php echo "$sreda"; ?> </b> <br><br><br></p>
                              ...
                              <td>
                                <div class="divider"></div>
                                  <p class="infoStanje">
                                  Vaš odgovor je: <b> <?php echo "$cetvrtak"; ?> </b> <br><br><br></p>
                              </td>

                              <td>
                                <div class="divider"></div>
                                  <p class="infoStanje">
                                  Vaš odgovor je: <b> <?php echo "$petak"; ?> </b> <br><br><br></p>
                              </td>

                              <td>
                                <div class="divider"></div>
                                  <p class="infoStanje">
                                  Vaš odgovor je: <b> <?php echo "$subota"; ?> </b> <br><br><br></p>
                              </td>

                              <td>
                                <div class="divider"></div>
                                  <p class="infoStanje">
                                  Vaš odgovor je: <b> <?php echo "$nedelja"; ?> </b> <br><br><br></p>
                              </td>
                            </tr>
                      </div>
                      <div class="row justify-content-center">
                                ...
                                <table>
                                    <tbody>                   
                                        ...
                                        <div class="collapse" id="ponedeljakCollapse">
                                              <label for="" id="filterTitle">Kako ćete prisustvovati poslu ovog dana?</label>
                                        </div>
                                            </td>
                                          </tr>
                                        </tbody>
                                        ...
                                        <tbody class="label">
                                          <tr>
                                            <td colspan="1"> <div class="collapse" id="utorakCollapse">
                                              <label for=""  id="filterTitle">Kako ćete prisustvovati poslu ovog dana?</label> </div>
                                            </td>
                                          </tr>
                                        </tbody>
                                        <div class="container">
