                ...
                <div id="myNav" class="overlayep">
                  ...
                  <div class="overlay-content">
                    ...
                    <?php  if (isset($_SESSION['korisnicko'])) : ?> 
                     ...
                     <?php endif ?>
                      <li><a href="logout.php"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="icon bi bi-box-arrow-left" viewBox="0 0 16 16">
                ...
                <div class="row">
                    <div class="col">
                     <div class="divider">
                       ...
                       <!-- [] -->
                        <div class="col">
                          <h2 class="header">Ulogujte se</h2>
                          ...
                          <form method="post" action="login.php">
                            ...
                            <div class="input-group" id="lozinka">
                              <label>Lozinka</label>
                            ...
                            <br>
                            <div class="input-group">
                              <button type="submit" class="button" name="log_korisnika"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                                <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
                              </svg></button>
                            </div>
                            <p>
                              Nemate nalog? <br>
                              <a href="register.php">Napravite nalog</a>
                            </p>
                          </form>
                      </div>
                     </div>
